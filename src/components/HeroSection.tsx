...
import { TrendingUp, Banknote, Users, Wrench, BarChart2 } from 'lucide-react';
...
const HeroSection = () => {
  ...
  const platformCards = [
    { title: "Finance Management", description: "Automated billing & collections", icon: <Banknote className="w-8 h-8" /> },
    ...
    { title: "Sales Management", description: "Bookings & inventory", icon: <BarChart2 className="w-8 h-8" /> }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-screen py-20">
          ...
          <div className="text-center lg:text-left space-y-6 lg:space-y-8">
            ...
            <div className="inline-flex items-center bg-white/10 backdrop-blur-md rounded-full px-4 sm:px-6 py-2 sm:py-3 mb-4 sm:mb-6 animate-on-scroll hover-lift border border-white/20">
              <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 text-white" />
